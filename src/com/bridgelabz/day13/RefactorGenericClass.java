...
public class RefactorGenericClass<T extends Comparable<T>> {
    ...
    public static void main(String[] args) {
        RefactorGenericClass<Integer> refactorGenericClass = new RefactorGenericClass();
        RefactorGenericClass<Float> refactorGenericClass1 = new RefactorGenericClass();
        RefactorGenericClass<String> refactorGenericClass2 = new RefactorGenericClass();
